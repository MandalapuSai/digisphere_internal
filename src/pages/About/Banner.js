...
import './Banners.css'; // Add appropriate CSS here

const Banner = () => {
  return (
    <section className="p-0 top-space-margin top-space position-relative overflow-hidden">
          ...
          >
            <div className="vertical-title-center align-items-center justify-content-center flex-shrink-0 w-75px sm-w-50px">
              <h1
                ...
                data-fancy-text='{"opacity": [0, 1], "translateY": [50, 0], "filter": ["blur(20px)", "blur(0px)"], "string": ["about digisphere Tech"], "duration": 400, "delay": 0, "speed": 50, "easing": "easeOutQuad"}'
              >
