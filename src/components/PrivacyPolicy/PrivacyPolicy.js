            ...
            <section className="top-space-margin">
                <div className="container">
                    <div className="row">
                        ...
                        >
                            <div
                                className="fs-140 xxl-fs-100 sm-fs-60 fw-600 text-dark-gray alt-font ls-minus-8px sm-ls-minus-2px"
                        ...
                        <div className="col-12">
                            <div
                                className="row align-items-center align-items-lg-end"
                                data-bottom-top="transform: translate3d(-30px, 0px, 0px);"
                                data-top-bottom="transform: translate3d(30px, 0px, 0px);"
                            >
                                <div
                                    className="col-lg-2 col-md-4 text-md-end text-center md-mt-30px md-mb-20px"
                                    data-anime='{"opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'
                                />
                            </div>
                        </div>
            ...
            <section id="down-section" className="pt-0">
                <div className="container">
                    <div className="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                        <div
                            className="col-xl-12 offset-xl-1 col-lg-6 col-md-10"
                        ...
                        >
                            ...
                            {/* Terms & Conditions */}
                            <h3 className="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font" id="h1">
                                Terms & Conditions
                            </h3>
                            <p className="electronic_p">
                                ...
                                <br />
                                3. The Platform is owned by Digisphere Tech Private Limited, a company incorporated under the
                                Companies Act, 1956 with its registered office at <strong> 3rd Floor, 305, Vamsee Apartment, Pillar No
                                    1079, Ameerpet ,Hyderabad ,India </strong> (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..
                                <br />
                            ...
                            <ul className="Platform_ul">
                                ...
                                <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive
                                    jurisdiction of the courts in <strong>Hyderabad </strong>  and <strong>Telangana.</strong> </li>
                            ...
                            {/* Privacy Policy */}
                            <h3 className="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font" id="h2">
                                Privacy Policy
                            </h3>
                            <p className="electronic_p">
                                This Privacy Policy describes how <strong>Digisphere Tech Private Limited</strong>  and its affiliates (collectively "
                                    <strong>Digisphere Tech Private Limited,</strong> we, our, us")collects, uses, shares, and protects your data through our website
                                    <Link to="/">https://www.digispheretech.in</Link>
                               <br/>
...
any information. If you receive an email, a call from a person/association claiming to be Digisphere
Tech Private Limited seeking any personal data like debit/credit card PIN, net-banking or mobile
...
<br/>
<strong> Usage-</strong> We use personal data to provide the services you request. To the extent we use your personal data
...
<br/>
<strong> Security Precautions-</strong> To protect your personal data from unauthorised access or disclosure, loss or
...
<br/>
<strong> Data Deletion and Retention-</strong> You have an option to delete your account by visiting your profile and
...
<br/>
<strong> Your Rights-</strong> You may access, rectify, and update your personal data directly through the functionalities
provided on the Platform.
<br/>
<strong> Consent-</strong> By visiting our Platform or by providing your information, you consent to the collection, use,
...
<br/>
<strong> Changes to this Privacy Policy- </strong> Please check our Privacy Policy periodically for changes. We may
...
Insert Name of the Office : Anu pothabathina<br/>
Designation : Admin<br/>
Company Address : Hyderabad, Ameerpet Telangana, 500016<br/>
Contact us : (+91)814 387-9627<br/>
Email : info@digispheretech.in

                    </p>

                    <br/><br/>
                    <h3 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font" id="h3">Refund and Cancellation policy</h3>
                    <p class="electronic_p" > This refund and cancellation policy outlines how you can cancel or seek a refund for a product / service
                        that you have purchased through the Platform. Under this policy:
                        </p>
                
                        <ul class="Platform_ul">
                            <li>Cancellations will only be considered if the request is made <strong>3 days </strong>  of placing the order. However,
                                ...
                                product is out for delivery. In such an event, you may choose to reject the product at the doorstep.</li>
                                    ...
                                    <li>In case of receipt of damaged or defective items, please report to our customer service team. The
                                        ...
                                        determined the same at its own end. This should be reported within <strong>3 days </strong> of receipt of products.
                                        In case you feel that the product received is not as shown on the site or as per your expectations,
                                        you must bring it to the notice of our customer service within <strong>3 days </strong>  of receiving the product. The
                                        ...
                                        <li>In case of complaints regarding the products that come with a warranty from the manufacturers,
                                            ...
                                            <li>In case of any refunds approved by <strong>Digisphere Tech Private Limited,</strong>  it will take <strong> 5 days </strong> for the
                                                refund to be processed to you.</li>
                        </ul>
<br/><br/>

                        <h3 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font" id="h4">Return Policy</h3>
                        <p class="electronic_p">
                            We offer refund / exchange within first <strong>3 days </strong> from the date of your purchase. If<strong>3 days </strong> have passed
...
be processed in <strong>7 days </strong> accordance with our policies.
                        </p>
                        <br/><br/>

                        <h3 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font" id="h5">Shipping Policy</h3>
                        <p class="electronic_p">
                            The orders for the user are shipped through registered domestic courier companies and/or speed post
only. Orders are shipped within <strong>7 days </strong> from the date of the order and/or payment or as per the delivery
