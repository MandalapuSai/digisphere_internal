...
// Direct path for footer logo in public folder
const FooterLogo = "/assets/img/logo2_footer.webp";

const Footer = () => {
  return (
    <footer className="bg-charcoal-blue pb-4 sm-pb-50px footer-links" style={{ backgroundImage: "url(/assets/images/demo-branding-agency-pattern.svg)" }}>
      <div className="container">
        <div className="row mb-6">
          ...
          <div className="col-lg-4 col-md-6 sm-mb-30px order-2 order-md-1">
            ...
            <div className="row">
              <div className="col-lg-5 col-6">
                <span className="alt-font fs-14 text-uppercase d-block text-white ls-1px lh-24 contact">Contact our office</span>
                <a href="tel:+918143879627">+91 814 387-9627</a>
              </div>
              <div className="col-lg-5 col-6 mail">
                <span className="alt-font fs-14 text-uppercase d-block text-white ls-1px lh-24">Send a message</span>
                <a href="mailto:info@digispheretech.in">info@digispheretech.in</a>
              </div>
            </div>
            <div className="pt-15px ">
              <ul className="extra-large-icon fw-600 social-media">
                <li>
                  <a className="facebook" href="https://www.facebook.com/Digispheretech.in/" target="_blank" rel="noopener noreferrer">
                    <span className="brand-label text-white"></span>
                    <span className="brand-icon fa-brands fa-facebook-f"></span>
                  </a>
                </li>
                <li>
                  <a className="twitter" href="https://x.com/_Digispheretech" target="_blank" rel="noopener noreferrer">
                    <span className="brand-label text-white"></span>
                    <span className="brand-icon fa-brands fa-x-twitter"></span>
                  </a>
                </li>
                <li>
                  <a className="linkedin" href="https://www.linkedin.com/company/digisphere-tech/" target="_blank" rel="noopener noreferrer">
                    <span className="brand-label text-white"></span>
                    <span className="brand-icon fa-brands fa-linkedin"></span>
                  </a>
                </li>
                <li>
                  <a className="instagram" href="https://www.instagram.com/digispheretech/" target="_blank" rel="noopener noreferrer">
                    <span className="brand-label text-white"></span>
          ...
          {/* Company Links */}
          <div className="col-md-2 col-6 order-3 order-md-2 ">
            <span className="alt-font fs-14 text-uppercase mb-5px d-block text-white ls-1px">Company</span>
            <ul>
        ...
        <p  style={{ color: 'rgba(170, 170, 170, 0.733)', textDecoration: 'none' }} >&copy; 2024 Powered by <Link to="/" style={{ color: 'rgba(170, 170, 170, 0.733)', textDecoration: 'none' }}>Digisphere Tech</Link></p>
